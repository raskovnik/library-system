    ...
    <body>
        <article>
            <form id="RegForm" method="POST" action="replace.php">
                ...
                <button name="accept" id="accept" style="width:100%; height: 30px; border-radius:10px; margin-left: 0px; margin-top: 15px ; margin-bottom: 7px; cursor: pointer;background-color: green;">Accept</button>        
                <a href="dashboard.php"><button style="margin-left: 0px;">Back to Dashboard</a>
                <?php
