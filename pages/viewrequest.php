...
<html lang="en">
    ...
    <body>
        ...
        <form method="POST">
            ...
            <input type="submit" name="reject" id="reject" value="Reject" class="btn" style="width:25%; height: 30px; border-radius:10px; padding: 7px 15px; margin-top: 15px; cursor: pointer;background-color: red;"><br>
        </form>
        </div>
        
        <a href="dashboard.php"><button style="margin-top: 0px;">Back to Dashboard</a>
